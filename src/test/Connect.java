...
public class Connect extends javax.swing.JFrame 
{
    ...
    private void initComponents() {
        ...
        jTextField1.setText("192.168.197.1");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            saida.println(jTextField3.getText());
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        try {
            cliente = new Socket(jTextField1.getText(), Integer.parseInt(jTextField2.getText()));
            jLabel3.setForeground(Color.green);
            jLabel3.setText("Connected");
            jLabel4.setText(jTextField1.getText()+" : "+jTextField2.getText());
        } catch (IOException ex) {}
        new Thread() {
            public void run(){
                try {
                    Scanner s = new Scanner(cliente.getInputStream());
                    jTextField4.setText(s.nextLine());
                } catch (IOException ex) {}
            }
        }.start();
